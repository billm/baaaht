...
.PHONY: all build test clean lint docker-build docker-run help build-orchestrator proto-gen proto-clean orchestrator worker
...
TOOLS=$(BUILD_DIR)/orchestrator $(BUILD_DIR)/worker
