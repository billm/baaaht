...
func (x *LLMStatusResponse) GetUptime() *timestamppb.Timestamp {
	if x != nil {
		return x.Uptime
	}
	return nil
...
const file_proto_llm_proto_rawDesc = "" +
	"\n" +
	"\x0fproto/llm.proto\x12\x06llm.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x12proto/common.proto\"\xe7\x02\n" +
	"\n" +
	"LLMRequest\x12\x1d\n" +
	"\n" +
	...
	"\ttimestamp\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\"\xc7\x03\n" +
...
var file_proto_llm_proto_depIdxs = []int32{
	...
	34, // 36: llm.v1.LLMStatusResponse.uptime:type_name -> google.protobuf.Timestamp
